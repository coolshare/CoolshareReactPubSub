...
Instructions to use:
 ...
 A). publish a topic in two ways:
  ...
  C). This example uses only React without using any Flux framework. See my other example for Redux at ttp://https://github.com/coolshare/CoolshareReactPubSubRedux 
